...
Сейчас в реализации слишком много времени занимает сортировка занятых блоков/свободного места.
занятые объекты совсем не нужны - можно заложить на них 14 байт (2 байта - на маркер, 4 байта - размер, 4 байта - адр предыдущего, 4 байта - адр следующего)
А со свободными надо подумать - бинарную кучу - неплохой вариант, только при дефрагментации его придется сортировать.
Лучше сделать маркеры свободных областей аналогичные маркерам занятых. А бинарную кучу свободных пересоздавать при дефрагментации, компактизации.
